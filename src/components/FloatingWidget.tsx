    ...
    <>
      ...
      >
        ...
        <button
          ...
          onClick={handleOpen}
          className="flex items-center gap-2.5 bg-[#EE7624] hover:bg-[#d66216] text-white px-5 py-3.5 rounded-full shadow-md transition-colors font-bold uppercase text-xs tracking-wider cursor-pointer"
      ...
      {isOpen && (
        ...
        >
          <div
            ...
            className="bg-white rounded-[4px] shadow-2xl border border-neutral-100 max-w-sm w-full relative overflow-hidden transition-all duration-150 scale-100"
            ...
            <div className="p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  type="submit"
                  className="w-full mt-4 bg-[#272623] hover:bg-[#1a1a1a] text-white font-extrabold text-xs uppercase tracking-wider py-3 px-4 rounded-[4px] shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer flex items-center justify-center gap-2"
                >
